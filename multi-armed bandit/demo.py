...
def epsilon_greedy_demo():
    arms = [BernoulliArm(0.1), BernoulliArm(0.1), BernoulliArm(0.1), BernoulliArm(0.1), BernoulliArm(0.9)]
    algorithms = [ABTest(5), EpsilonGreedy(5, 0.1), EpsilonGreedy(5, 0.25), EpsilonGreedy(5, 0.75), EpsilonGreedy(5, 1)]
    ss = [algorithm_demo(arms, algorithm, 1000) for algorithm in algorithms]
    [plt.plot(range(1000), ss[i], label=algorithms[i].name) for i in range(5)]
